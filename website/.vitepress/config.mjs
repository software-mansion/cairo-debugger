...
export default defineConfig({
    title: "Cairo Debugger",
    description:
        "Cairo Debugger is an implementation of Debug Adapter Protocol for the Cairo language.",
    lang,
    base,
    ...
    head: [
        ...
        ["meta", {name: "apple-mobile-web-app-title", content: "Cairo Debugger"}],
    ...
    themeConfig: {
        ...
        socialLinks: [
            {icon: "github", link: "https://github.com/software-mansion/cairo-debugger"},
            {icon: "twitter", link: "https://twitter.com/swmansionxyz"},
            {
                ...
                ariaLabel: "Telegram",
                link: "https://t.me/starknet_foundry_support",
            },
        ],
    },
